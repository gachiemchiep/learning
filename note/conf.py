...
latex_documents = [('index', 'test.tex', u'test Documentation', u'vugia truong', 'manual')]
...
man_pages = [('index', 'test', u'test Documentation', [u'vugia truong'], 1)]
